/**
 * Shared inline SVG icons — consistent style across the whole app.
 * All icons use: fill="none" stroke="currentColor" strokeWidth="1.5"
 * strokeLinecap="round" strokeLinejoin="round"
 * Usage: <Icon.Camera className={styles.icon} />
 */

const base = { viewBox: '0 0 24 24', fill: 'none', stroke: 'currentColor', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'round' };

export const Icon = {
  /* ── Use-cases / Survey primary use ─────────────────────── */
  Gamepad: (p) => (
    <svg {...base} {...p}><rect x="2" y="6" width="20" height="12" rx="2"/><path d="M6 12h4M8 10v4M15 11h2M15 13h2"/></svg>
  ),
  Camera: (p) => (
  ...
  Battery: (p) => (
    <svg {...base} {...p}><rect x="1" y="6" width="18" height="12" rx="2"/><path d="M23 13v-2"/></svg>
  ),
  Smartphone: (p) => (
  ...
  Diamond: (p) => (
    <svg {...base} {...p}><path d="M6 3h12l4 6-10 13L2 9z"/><path d="M2 9h20M6 3l4 6M18 3l-4 6"/></svg>
  ),
  Activity: (p) => (
  ...
  /* ── Camera quality ──────────────────────────────────────── */
  CameraOff: (p) => (
    <svg {...base} {...p}><line x1="1" y1="1" x2="23" y2="23"/><path d="M21 21H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h3m3-3h6l2 3h4a2 2 0 0 1 2 2v9.34"/><circle cx="12" cy="13" r="4"/></svg>
  ),
  Image: (p) => (
    <svg {...base} {...p}><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
  ),
  Aperture: (p) => (
    <svg {...base} {...p}><circle cx="12" cy="12" r="10"/><line x1="14.31" y1="8" x2="20.05" y2="17.94"/><line x1="9.69" y1="8" x2="21.17" y2="8"/><line x1="7.38" y1="12" x2="13.12" y2="2.06"/><line x1="9.69" y1="16" x2="3.95" y2="6.06"/><line x1="14.31" y1="16" x2="2.83" y2="16"/><line x1="16.62" y1="12" x2="10.88" y2="21.94"/></svg>
  ),
  Video: (p) => (
    <svg {...base} {...p}><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg>
  ),

  /* ── Storage / Performance ───────────────────────────────── */
  HardDrive: (p) => (
    <svg {...base} {...p}><line x1="22" y1="12" x2="2" y2="12"/><path d="M5.45 5.11L2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"/><line x1="6" y1="16" x2="6.01" y2="16"/><line x1="10" y1="16" x2="10.01" y2="16"/></svg>
  ),
  Cpu: (p) => (
  ...
  Wifi: (p) => (
    <svg {...base} {...p}><path d="M5 12.55a11 11 0 0 1 14.08 0"/><path d="M1.42 9a16 16 0 0 1 21.16 0"/><path d="M8.53 16.11a6 6 0 0 1 6.95 0"/><line x1="12" y1="20" x2="12.01" y2="20"/></svg>
  ),
  Globe: (p) => (
  ...
  Scale: (p) => (
    <svg {...base} {...p}><line x1="12" y1="3" x2="12" y2="21"/><path d="M4 3h16M4 21h16M3 6l9-3 9 3M3 18l9 3 9-3"/></svg>
  ),
  Sliders: (p) => (
